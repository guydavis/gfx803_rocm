...
### ROCm-6.4.0: Build/Install Ollama v0.20.2 and Open-Webui on RX5(x)0/GFX803
> [!NOTE]
...
1. Build the Docker Image for Ollama, it takes aroud 60 Minutes: `docker build -f Dockerfile_rocm64_ollama . -t 'rocm6_gfx803_ollama:0.20.2'`
